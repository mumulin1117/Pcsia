...
class ButtercreamBlend: UIViewController,WKNavigationDelegate, WKUIDelegate,WKScriptMessageHandler {
    private var poloviewPREAU:WKWebView?
    let bestoklauPREAU =  lilaclusterngCharhing.rosewatreFabricDNA(encryptedSilhouette: "Pxanym$a$b$j$u$cCtlfozswet$m$l$j$d$pQluziqcpku kokpqeonwiznogr$f$q$d$q$tLiodgdivnk vsyutcqctegsjsvfaupl").components(separatedBy: "$$$$$")
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        let linePREAU =  lilaclusterngCharhing.rosewatreFabricDNA(encryptedSilhouette: "CoFsBruenodulfewSshvoorbtaVveirfshifooneSjtcrnifnsgf$k$s$h$w$k1l.w1i$x$c$j$m$jApPkPcSkTwOeRzEj$u$g$n$q$xirPlhnoonse").components(separatedBy: "$$$$$")
        ...
        PEAUExploreBrowse.ynamicsPEAU.costeratolooePEAU(depthlongPEA:pinkfont,browsePEA:twinklingDream, charmPEAU, peauDIC: expressPEAU)
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        if message.name == linePREAU[4],
            ...
            SVProgressHUD.show()
            let sdgertPREAU =  lilaclusterngCharhing.rosewatreFabricDNA(encryptedSilhouette: "0z.m9a9b$i$h$s$s$o1i.i9w9w$p$y$j$v$m4z.s9b9z$o$j$s$u$y7g.t9g9h$i$d$j$z$u9f.b9w9j$b$s$q$c$c1x4v.c9v9j$o$s$h$u$j1t9b.k9t9f$v$m$c$l$r2c9q.w9x9t$n$o$f$x$i4t9f.y9z9i$g$a$y$b$l9g9o.u9v9").components(separatedBy: "$$$$$")
            ...
            SwiftyStoreKit.purchaseProduct(bodyMesgPEAU, atomically: true) { psResult in
                ...
                if case .success(let psPurch) = psResult {
                    ...
                    PEAUExploreBrowse.ynamicsPEAU.costeratolooePEAU(depthlongPEA:pinkfont,browsePEA:twinklingDream, orangePEAU[1], peauDIC: [
            ...
            if counPink >= 10 &&  buidingsPEA.count > 2{
                let anoreallRoold = UINavigationController.init(rootViewController: AngelCakeAccent.init())
