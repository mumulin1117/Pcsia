...
import CDAlertView
/// 发起挑战
class CrepeBlush: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        addedCoverButtonPEA.addTarget(self, action: #selector(silkenSonnet), for: .touchUpInside)
    }
...
extension  CrepeBlush :UINavigationControllerDelegate, UIImagePickerControllerDelegate{
