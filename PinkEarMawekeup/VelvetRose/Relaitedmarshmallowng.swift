...
class Relaitedmarshmallowng: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    var pickresultPEa:Array<Dictionary<String,String>>{
        if peahomePickTag == 1000 {
            return WisteriaWash.unniqiePEa.relationdataYuangzuPEA.PEAFollowings
            
        }else {
            return WisteriaWash.unniqiePEa.relationdataYuangzuPEA.PEAFollwers
        }
    }
    ...
    override func viewDidLoad() {
        ...
        if peahomePickTag == 1000 {
            fowerfdingPEAd.text = lilaclusterngCharhing.rosewatreFabricDNA(encryptedSilhouette: "Fqowlrlhoawciwnsges")
        }else{
            fowerfdingPEAd.text = lilaclusterngCharhing.rosewatreFabricDNA(encryptedSilhouette: "Ffofltlwobwaecrps")
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let peacCell = collectionView.dequeueReusableCell(withReuseIdentifier: "PEAURelaitedellID", for: indexPath) as! Carnationlaitedell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let descibePEAVC = Strawberryrtutyingfing.init(depthlongPEA:pinkfont,changeDescibeDatPEA: pickresultPEa[indexPath.row],browsePEA:twinklingDream)
